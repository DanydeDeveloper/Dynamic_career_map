...
`ANTHROPIC_API_KEY` включает Claude-черновики характеристики, стратегии и предложений изменений. Если ключ не задан или Claude API недоступен, приложение продолжает работать через rule-based fallback.
