...
`OPENAI_API_KEY` включает AI-черновики характеристики, стратегии и предложений изменений. Если ключ не задан или API недоступен, приложение продолжает работать через rule-based fallback.
