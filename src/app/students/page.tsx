...
const pageCopy = {
  ...
  CURATOR: {
    eyebrow: "Ученики",
    title: "Мои ученики",
    description: "Педагог видит текущие профили, ближайшие события и предложения изменений по своим ученикам."
  },
  PARENT: {
    eyebrow: "Ребенок",
  ...
  STUDENT: {
    ...
    description: "Профиль интересов, ближайшие мероприятия и предложения, которые педагог проверяет перед обновлением карты."
  }
};
