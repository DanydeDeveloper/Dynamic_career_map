...
const dashboardCopy = {
  ...
  CURATOR: {
    eyebrow: "Кабинет куратора",
    title: "Рабочая панель сопровождения",
    description:
      "Здесь собраны ученики, ближайшие профпробы, обратная связь и предложения изменений, которые куратор согласует перед обновлением карты."
  },
  PARENT: {
    eyebrow: "Кабинет родителя",
    title: "Карта развития ребенка",
    description:
      "Родитель видит профиль ребенка, назначенные мероприятия и может оставить обратную связь после участия, чтобы куратор уточнил траекторию."
  },
  STUDENT: {
